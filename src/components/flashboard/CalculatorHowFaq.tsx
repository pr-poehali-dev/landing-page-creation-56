...
const STEPS = [
  {
    ...
    desc: "Оставляете заявку на сайте, в WhatsApp или звоните. В течение часа присылаем смету и свободные даты.",
    time: "5 минут",
  },
  {
      ...
      <section id="how">
        <div className="fb-wrap">
          ...
          <div className="fb-tech">
            <div>
              <h3>Технические требования к ролику</h3>
              <p>Экран вертикальный, 5,76 × 8,64 м. Если ваш ролик горизонтальный — адаптируем бесплатно при заказе от 30 дней.</p>
            </div>
