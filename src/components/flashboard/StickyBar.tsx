...
export default function StickyBar({ visible }: StickyBarProps) {
  return (
    <div className={`fb-sticky${visible ? " fb-sticky-on" : ""}`}>
      <a className="fb-sticky-btn fb-sticky-call" href="tel:+79089925020">
      ...
      <a className="fb-sticky-btn fb-sticky-tg" href="https://t.me/izumrudvlpm" target="_blank" rel="noopener noreferrer">
