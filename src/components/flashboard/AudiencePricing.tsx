    ...
    <>
      ...
      <section className="fb-gray" id="pricing">
        <div className="fb-wrap">
          ...
          <div className="fb-fine">Минимальный срок размещения — 5 дней. Производство видеоролика под экран — от 7 500 ₽. Для агентств и сетевых клиентов — индивидуальные условия.</div>
        </div>
      </section>
    </>
  );
