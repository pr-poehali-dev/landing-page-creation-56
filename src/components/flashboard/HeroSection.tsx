...
const TICKER_ITEMS = [
  ...
  "Остановка «ТЦ Изумруд» прямо под экраном — 19 маршрутов автобусов",
  "Фото- и видеоотчёт о размещении",
  "Производство ролика от 7 500 ₽",
  "Запуск за 1 день, размещение от 5 дней",
  "Экран 5,76 × 8,64 м — видимость до 80 метров",
  "В эфире ежедневно с 06:00 до 23:00",
];
