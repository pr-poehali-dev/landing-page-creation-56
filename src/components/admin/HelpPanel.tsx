...
const STEPS = [
  {
    ...
    text: "С сайта заявки приходят сами со статусом «Новая». Если клиент позвонил — «Добавить заявку вручную» вверху: достаточно имени и телефона. Телефоны в списке скрыты — нажмите на номер, чтобы увидеть целиком.",
  },
  {
    icon: "CalendarRange",
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                ...
                <ul className="text-xs text-amber-800 leading-relaxed mt-1.5 space-y-1">
                  ...
                  <li>· Открытие телефона клиента и выгрузка базы фиксируются в журнале. Руководитель видит, кто и когда это делал.</li>
                </ul>
              </div>
            </div>
          </div>
