...
const STEPS = [
  ...
  },
  {
    ...
    text: "Кнопка «Условия» в карточке: стоимость, даты размещения, хронометраж ролика. Эти данные подставляются в договор — если чего-то не хватает, система предупредит заранее.",
  },
  {
    icon: "Building2",
  ...
  },
  {
    ...
    text: "Кнопка «Сформировать договор» — документ собирается за пару секунд и остаётся в карточке. Рядом с файлом есть значок конверта: отправит договор клиенту на почту вложением.",
  },
  {
    icon: "Wallet",
